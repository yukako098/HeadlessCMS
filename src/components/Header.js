...
class Header extends React.Component {
    ...
    render() {
        //TODO: put if state in onClick method
        const showSlideNav = () => {
            this.setState({
            ...
            var slide_nav = document.getElementById("slide-nav");
            var black_bg_filter = document.getElementById("black-bg-filter");
            var main_body_section = document.getElementById(
                "main-body-section"
            );
            var footer = document.getElementById("footer");
            // var contact_section = document.getElementById("contact-section");
        ...
        return (
            <div>
                ...
                <div
                    id="black-bg-filter"
                    className="black-bg-filter w-100 h-100"
                />
                <header>
                    <section className="title-section d-flex justify-content-between p-3 pr-5 pl-5">
                        ...
                        <h1 className="top-title yellowtail display-1">
                            yukaLog
                        </h1>
